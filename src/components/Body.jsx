...
const Body = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-around items-center gap-10 lg:gap-2 mt-4  px-4 pt-10 lg:px-12 overflow-hidden">
      <div className="flex flex-col  lg:items-start items-center">
        <h1 className="text-[2.2rem] sm:text-[3rem] md:text-[4rem] lg:text-[4.5rem] font-semibold  md:leading-[5rem] text-center lg:text-left">
          ...
          <p className="mt-[20px] text-gray-600 italic text-[.9rem] sm:text-[.8rem]  lg:text-left text-center sm:w-[100%]">
